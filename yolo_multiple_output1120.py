...
from yolo3.model_Mobilenet import yolo_eval, yolo_body, tiny_yolo_body, compute_iou
...
class YOLO(object):
    _defaults = {
        "model_path": 'model_data/trained_weights_final_type_m.h5',
...
class YOLO2(object):
    _defaults = {
        "model_path": 'model_data/trained_weights_final_color_m.h5',
        "anchors_path": 'model_data/yolo_anchors_color.txt',
        "classes_path": 'model_data/color_classesv2.txt',
        "score" : 0.3,
        "iou" : 0.45,
